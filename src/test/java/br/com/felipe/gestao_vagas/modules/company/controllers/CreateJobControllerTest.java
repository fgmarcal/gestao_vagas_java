...
import br.com.felipe.gestao_vagas.utils.TestUtils;
...
public class CreateJobControllerTest {
    ...
    public void should_be_able_to_create_a_new_job() throws Exception{
        ...
        var createdJobBTO = CreateJobDTO.builder()
        ...
        var result = mvc.perform(
            ...
            .content(TestUtils.objectToJson(createdJobBTO))
            .header("Authorization", TestUtils.generateToken(company.getId(), "JAVAGAS_TK_@123#")))
    ...
    public void should_not_be_able_to_create_a_new_job_without_company() throws Exception{
        ...
        mvc.perform(
            ...
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtils.objectToJson(createdJobBTO))
            .header("Authorization", TestUtils.generateToken(UUID.randomUUID(), "JAVAGAS_TK_@123#")))
